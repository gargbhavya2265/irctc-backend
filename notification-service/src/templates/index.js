  ...
  return `
    ...
    ">
      ...
      <div style="text-align: center; margin-bottom: 20px;">
        <h2 style="color: #4A3AFF; margin: 0;">
          🚆 RailConnect
        </h2>
      </div>
      ...
      <p style="
        ...
        text-align: center;
      ">
        Thank you for choosing RailConnect 🚆<br/>
        <strong>Team RailConnect</strong>
      </p>
...
function getWelcomeTemplate(firstName) {
  return `
    ...
    ">
      ...
      <p style="font-size: 16px; color: #333;">
        Welcome to <strong>RailConnect</strong> 👋
      </p>

      <p style="font-size: 16px; color: #333;">
        Your account has been successfully created and your email address
        has been verified.
      </p>

      <p style="font-size: 16px; color: #333;">
        You can now log in to your account and start exploring train
        journeys and booking options.
      </p>
...
function getTicketConfirmationTemplate(ticketData) {
  ...
  return `
    ...
    ">
      ...
      <p style="font-size: 16px; color: #333;">
        Your train ticket has been successfully confirmed.
      </p>
      ...
      ">
        ...
        <p style="margin: 5px 0; font-size: 16px;">
          <strong>Train:</strong> ${trainName} (${trainNumber})
        </p>
...
const FAILURE_REASON_MESSAGES = {
  ...
  booking_timeout:
    'Your booking expired before payment was completed.',
};
...
const CANCELLATION_REASON_MESSAGES = {
  ...
  schedule_cancelled:
    'The train schedule for this booking was cancelled.',
};
...
function getBookingConfirmedTemplate(data) {
  ...
  return `
    ...
    ">
      ...
      <p style="font-size: 16px; color: #333;">
        Great news! Your train booking has been successfully confirmed.
        Here are your journey details:
      </p>
      ...
      <div style="margin: 20px 0;">
        ...
        ${fromStationName
          ? `<p style="margin: 10px 0;"><strong>From:</strong> ${fromStationName}</p>`
          : ''
        }

        ${toStationName
          ? `<p style="margin: 10px 0;"><strong>To:</strong> ${toStationName}</p>`
          : ''
        }
      ...
      ${seats.length ? `
        ...
        <div style="margin: 20px 0;">
          ...
          ${seats.map(s => `
            <p style="margin: 5px 0;">
              Seat ${s.seatNumber} — ${s.seatType} (₹${s.price})
            </p>
          `).join('')}
      ...
      <p style="
        ...
        text-align: center;
      ">
        Thank you for booking with RailConnect 🚆<br/>
        <strong>Team RailConnect</strong>
      </p>
...
function getBookingFailedTemplate(data) {
  ...
  const friendlyReason =
    FAILURE_REASON_MESSAGES[reason]
  ...
  return `
    ...
    ">
      ...
      <p style="font-size: 16px; color: #333;">
        We're sorry, but we were unable to complete your train booking.
      </p>
      ...
      ">
        ...
        <p style="margin: 5px 0; font-size: 16px;">
          <strong>Reason:</strong> ${friendlyReason}
        </p>
      ...
      <p style="font-size: 15px; color: #555;">
        You can try booking your journey again from your RailConnect account.
      </p>
...
function getBookingCancelledTemplate(data) {
  ...
  const friendlyReason =
    CANCELLATION_REASON_MESSAGES[reason]
  ...
  return `
    ...
    ">
      ...
      <p style="font-size: 16px; color: #333;">
        Your train booking has been successfully cancelled.
      </p>
      ...
      <p style="
        ...
        text-align: center;
      ">
        We hope to have you onboard again soon 🚆<br/>
        <strong>Team RailConnect</strong>
      </p>
